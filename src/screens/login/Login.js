...
class Login extends Component {
  ...
  loginClickHandler = () => {
    ...
    if (
      this.state.username === "balajiv" &&
      this.state.password === "upgrad@123"
    ) {
      sessionStorage.setItem("username", "balajiv");
      sessionStorage.setItem(
        "access-token",
        "IGQVJWZATR3emV0bzh3eVpiR2IxcDdUejlYMFA4UDhzT0JDeFljQ1J5WUNMcnc1UGhqa3ZAhemhYWGJ3ZAVB5ZA2RWMV9kOW9WRzBObDdiYXNvNHJVWjBTRHI3b19nNFlCRnNNNHFLOTJnSDlUamQwazNxdwZDZD"
      );
